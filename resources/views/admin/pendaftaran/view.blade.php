<x-admin-layout title="{{ $title }}">
    ...
    <script>
        ...
        let untukApprove = function() {
            $(document).on('click', '#btn-approve', function() {
                var ini = $(this);

                Swal.fire({
                    title: "Apakah Anda yakin ingin menyetujui pendaftaran ini?",
                    icon: "warning",
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ route('admin.pendaftaran.approved') }}",
                        dataType: 'json',
                        data: {
                            id: ini.data('id'),
                            approved: ini.data('approve'),
                        },
                        beforeSend: function() {
